...
2. **Web Based File Explorer For Linux**
   - A web-based Linux file explorer allowing users to view and manage files and directories through a browser, developed using MVC architecture.
   - [Project Link](https://github.com/Thalindor/Web-Based-File-Explorer-for-Linux)
...
![tryhackme stats](https://raw.githubusercontent.com/Thalindor/Thalindor/master/assets/thm_propic.png)
